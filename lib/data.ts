...
}[] = [
  {
    ...
    work_exp: [
      ...
      },
      {
        ...
        currently_working: false,
        description_points: [
          "Architected a CMS and ticket management platform with Next.js and Flask to streamline internal support.",
    ...
    work_exp: [
      {
        ...
        currently_working: false,
        description_points: [
          "Built end-to-end SaaS platforms in Next.js and Express.js — REST APIs, admin dashboards, auth systems.",
...
export const projectConstant: {
...
}[] = [
  {
    ...
    tech_stack: ["Next.js", "FastAPI", "MongoDB", "OpenAI", "Razorpay", "AWS"],
    sub: "e-learning",
  },
  {
    ...
    tech_stack: ["Next.js", "FastAPI", "MongoDB", "Redis", "GenAI", "ETL"],
    sub: "crm",
  },
  {
    ...
    tech_stack: ["Next.js", "Flask", "MySQL", "Google AppScript"],
    sub: "helpdesk",
  },
  {
    title: "Pigeon",
    ...
    tech_stack: ["Next.js", "Express.js", "MongoDB", "AWS"],
    sub: "admin panel",
  },
  {
    ...
    tech_stack: ["Flask", "Deep Learning", "Computer Vision", "ML"],
    sub: "accessibility",
  },
];
